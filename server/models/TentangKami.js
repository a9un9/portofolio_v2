...
const TentangKami = sequelize.define('TentangKami', {
  deskripsi: {
    type: DataTypes.TEXT,
    allowNull: false,
  },
...
TentangKami.belongsTo(User, { foreignKey: 'user_id' });  // Relasi dengan User
